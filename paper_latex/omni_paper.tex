...
A survey of 35 recent agentic papers (Section~\ref{sec:related}) confirms that no prior system provides structural mechanisms for all five failure modes simultaneously. The full implementation is available at \url{https://github.com/Ravian-Omni/omni-backend}.
